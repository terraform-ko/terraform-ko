...
translated: false
source: "terraform/docs/language/validate/index.mdx"
---
...
> 원문: [terraform/docs/language/validate/index.mdx](https://developer.hashicorp.com/terraform/language/validate)
