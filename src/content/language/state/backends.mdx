...
translated: false
source: "terraform/docs/language/state/backends.mdx"
---
...
> 원문: [terraform/docs/language/state/backends.mdx](https://developer.hashicorp.com/terraform/language/state/backends)
