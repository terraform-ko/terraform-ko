...
translated: false
source: "terraform/docs/language/state/remove.mdx"
---
...
> 원문: [terraform/docs/language/state/remove.mdx](https://developer.hashicorp.com/terraform/language/state/remove)
